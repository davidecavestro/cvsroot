...
package com.ost.timekeeper.report.filter;

/**
 * Un contenitore di filtro associato all'obiettivo su cui è incentrato.
 *
 * @author  davide
 */
public final class TargetedFilterContainer {
	...
	/**
	 * Ritorna <TT>true</TT> se questo contenitore è uguale all'oggetto specificato.
	 *
	 * @param obj l'oggettosùdicui testare l'uguaglianza.
	 * @return <TT>true</TT> se questo contenitore è uguale all'oggetto specificato.
	 */	
