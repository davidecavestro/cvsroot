...
public class LocalizedPeriodImpl extends Observable implements LocalizedPeriod {
	 ...
	 * un valore negativo se la data d'inizio del periodo specificato è 
	 * antecedente all'inizio di questo periodo;
	 * e un valore positivo se la data d'inizio del periodo specificato è 
	 ...
	 * un valore negativo se la data di fine del periodo specificato è 
	 * antecedente alla fine di questo periodo;
	 * e un valore positivo se la data di fine del periodo specificato è 
