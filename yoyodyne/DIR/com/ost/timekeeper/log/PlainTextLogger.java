...
public class PlainTextLogger implements Logger{
	 ...
	 */
	public PlainTextLogger (final File logFile, final boolean append) throws IOException {
		FileUtils.makeFilePath (logFile);
		final int bufferSize = Application.getOptions ().getPlainTextLogBufferSize ();
		try {
