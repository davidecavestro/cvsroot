 ...
 * @author  davide
 */
public class SpecifyProjectNameDialog extends javax.swing.JDialog implements DialogNotifier {
	
	private final DialogNotifierImpl _dialogNotifier;
	
	/** Costruttore. */
	public SpecifyProjectNameDialog (java.awt.Frame parent, boolean modal) {
		super (parent, modal);
		initComponents ();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle(java.util.ResourceBundle.getBundle("com.davidecavestro.timekeeper.gui.res").getString("Specify_bundle:_base_name"));
        setResizable(false);
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, java.util.ResourceBundle.getBundle("com.davidecavestro.timekeeper.gui.res").getString("Please_&specify_bundle_base_name:"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
