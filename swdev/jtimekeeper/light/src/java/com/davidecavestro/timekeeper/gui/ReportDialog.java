...
//		hide ();
	...
	void launchReport () {
		...
		final JRBindings jrb = new JRBindings (getClass ().getResourceAsStream ("/cumulatelocalprogresses.jasper"));
...
//		}
		...
		if (_usePresets) {
			...
			periodLength = from.get (Calendar.DAY_OF_YEAR) - to.get (Calendar.DAY_OF_YEAR);
		}
